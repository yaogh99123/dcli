...
func germanSet() TranslationSet {
	return TranslationSet{
		...
		ErrorOccurred:                     "Es ist ein Fehler aufgetreten! Bitte erstelle ein Issue hier: https://github.com/jesseduffield/dcli/issues",
		...
		MenuTitle:          "Menü",
		Scroll:             "scrollen",
		OpenConfig:         "öffne dcli Konfiguration",
		EditConfig:         "bearbeite dcli Konfiguration",
		Cancel:             "abbrechen",
		Remove:             "entfernen",
		...
		PressEnterToReturn:          "Drücke Eingabe um zu dcli zurückzukehren. (Diese Nachfrage kann in Deiner Konfiguration deaktiviert werden, indem du folgenden Wert setzt: `gui.returnImmediately: true`)",
