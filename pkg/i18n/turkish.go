...
func turkishSet() TranslationSet {
	return TranslationSet{
		...
		ErrorOccurred:                     "Bir hata oluştu! Lütfen https://github.com/jesseduffield/dcli/issues adresinden bir hataya ilişkin konu oluşturun",
		...
		CannotAccessDockerSocketError:     "Docker' a şu adresten erişilemiyor : unix:///var/run/docker.sock\n dcli' ı root(kök kullanıcı) olarak çalıştır veya şu adresteki adımları takip et : https://docs.docker.com/install/linux/linux-postinstall/",
		...
		PressEnterToReturn:          "dcli' a geri dönmek için enter tuşuna basın ( Bu uyarı, `gui.return Immediately: true` ayarıyla devre dışı bırakılabilir)",
