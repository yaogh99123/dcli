...
func frenchSet() TranslationSet {
	return TranslationSet{
		...
		ErrorOccurred:              "Une erreur s'est produite ! Veuillez créer un rapport d'erreur sur https://github.com/jesseduffield/dcli/issues",
		...
		CannotAccessDockerSocketError:     "Impossible d'accéder au socket Docker à : unix:///var/run/docker.sock\nLancez dcli en tant que root ou alors lisez https://docs.docker.com/install/linux/linux-postinstall/",
		...
		OpenConfig:                  "ouvrir la configuration dcli",
		EditConfig:                  "modifier la configuration dcli",
		Cancel:                      "annuler",
		Remove:                      "supprimer",
		...
		PressEnterToReturn:          "Appuyez sur Entrée pour revenir à dcli (ce message peut être désactivé dans vos configurations en appliquant `gui.returnImmediately: true`)",
