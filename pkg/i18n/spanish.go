...
func spanishSet() TranslationSet {
	return TranslationSet{
		...
		Menu:                        "menú",
		MenuTitle:                   "Menú",
		OpenConfig:                  "abrir configuración de dcli",
		EditConfig:                  "editar configuración de dcli",
		Cancel:                      "cancelar",
		Remove:                      "borrar",
		...
		PressEnterToReturn:         "Presionar [enter] para volver a dcli (este mensaje puede ser desactivado en tu configuración poniendo `gui.returnImmediately: true`)",
