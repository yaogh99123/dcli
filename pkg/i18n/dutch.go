...
func dutchSet() TranslationSet {
	return TranslationSet{
		...
		ErrorOccurred:                     "Er is iets fout gegaan! Zou je hier een issue aan willen maken: https://github.com/jesseduffield/dcli/issues",
		...
		MenuTitle:          "Menu",
		Scroll:             "scroll",
		OpenConfig:         "open de dcli configuratie",
		EditConfig:         "verander de dcli configuratie",
		Cancel:             "annuleren",
		Remove:             "verwijder",
		...
		PressEnterToReturn:          "Druk op enter om terug te gaan naar dcli (Deze popup kan uit gezet worden door in de config dit neer te zetten `gui.returnImmediately: true`)",
