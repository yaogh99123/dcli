...
func portugueseSet() TranslationSet {
	return TranslationSet{
		...
		MenuTitle:                   "Menu",
		Scroll:                      "rolar",
		OpenConfig:                  "abrir configuração do dcli",
		EditConfig:                  "editar configuração do dcli",
		Cancel:                      "cancelar",
		Remove:                      "remover",
		...
		PressEnterToReturn:          "Pressione enter para retornar ao dcli (este prompt pode ser desativado em sua configuração definindo `gui.returnImmediately: true`)",
