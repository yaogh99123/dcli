...
func polishSet() TranslationSet {
	return TranslationSet{
		...
		ErrorOccurred:                     "Wystąpił błąd! Proszę go zgłosić na https://github.com/jesseduffield/dcli/issues",
		...
		PressEnterToReturn:          "Wciśnij enter aby powrócić do dclia (ten komunikat może być wyłączony w konfiguracji poprzez ustawienie `gui.returnImmediately: true`)",
