...
<br>
<br>
<a href="https://www.warp.dev/?utm_source=github&utm_medium=referral&utm_campaign=dcli_20231023">
  <div>
...
[![Go Report Card](https://goreportcard.com/badge/github.com/jesseduffield/dcli)](https://goreportcard.com/report/github.com/jesseduffield/dcli)
[![GolangCI](https://golangci.com/badges/github.com/jesseduffield/dcli.svg)](https://golangci.com)
[![GoDoc](https://godoc.org/github.com/jesseduffield/dcli?status.svg)](http://godoc.org/github.com/jesseduffield/dcli)
![GitHub repo size](https://img.shields.io/github/repo-size/jesseduffield/dcli)
[![GitHub Releases](https://img.shields.io/github/downloads/jesseduffield/dcli/total)](https://github.com/jesseduffield/dcli/releases)
[![GitHub tag](https://img.shields.io/github/tag/jesseduffield/dcli.svg)](https://github.com/jesseduffield/dcli/releases/latest)
[![homebrew](https://img.shields.io/homebrew/v/dcli)](https://github.com/Homebrew/homebrew-core/blob/master/Formula/dcli.rb)
...
<p align="center">
 Maintenance of this project is made possible by all the <a href="https://github.com/jesseduffield/dcli/graphs/contributors">contributors</a> and <a href="https://github.com/sponsors/jesseduffield">sponsors</a>. If you'd like to sponsor this project and have your avatar or company logo appear below <a href="https://github.com/sponsors/jesseduffield">click here</a>. 💙
</p>
...
Memorising docker commands is hard. Memorising aliases is slightly less hard. Keeping track of your containers across multiple terminal windows is near impossible. What if you had all the information you needed in one terminal window with every common command living one keypress away (and the ability to add custom commands as well). Dcli's goal is to make that dream a reality.

- [Requirements](https://github.com/jesseduffield/dcli#requirements)
- [Installation](https://github.com/jesseduffield/dcli#installation)
- [Usage](https://github.com/jesseduffield/dcli#usage)
- [Keybindings](/docs/keybindings)
- [Cool Features](https://github.com/jesseduffield/dcli#cool-features)
- [Contributing](https://github.com/jesseduffield/dcli#contributing)
- [Video Tutorial](https://youtu.be/NICqQPxwJWw)
- [Config Docs](/docs/Config.md)
- [Twitch Stream](https://www.twitch.tv/jesseduffield)
- [FAQ](https://github.com/jesseduffield/dcli#faq)
...
Normally `dcli` formula can be found in the Homebrew core but we suggest you to tap our formula to get frequently updated one. It works with Linux, too.

**Tap**:
```sh
brew install jesseduffield/dcli/dcli
```
...
You can install `dcli` using [scoop](https://scoop.sh/):
...
You can install `dcli` using [Chocolatey](https://chocolatey.org/):
...
You can install [asdf-dcli plugin](https://github.com/comdotlinux/asdf-dcli) using [asdf-vm](https://asdf-vm.com/):
#### Setup (Once)
```sh
asdf plugin add dcli https://github.com/comdotlinux/asdf-dcli.git
```

#### For Install / Upgrade
```sh
asdf list all dcli
asdf install dcli latest
asdf global dcli latest
```

### Binary Release (Linux/OSX/Windows)

You can manually download a binary release from [the release page](https://github.com/jesseduffield/dcli/releases).

Automated install/update, don't forget to always verify what you're piping into bash:

```sh
curl https://raw.githubusercontent.com/jesseduffield/dcli/master/scripts/install_update_linux.sh | bash
```
...
```sh
go install github.com/jesseduffield/dcli@latest
```

Required Go version >= **1.8**, <= **1.17**

```sh
go get github.com/jesseduffield/dcli
```

### Arch Linux AUR

You can install dcli using the [AUR](https://aur.archlinux.org/packages/dcli) by running:
...
[![Docker Pulls](https://img.shields.io/docker/pulls/lazyteam/dcli.svg)](https://hub.docker.com/r/lazyteam/dcli)
[![Docker Stars](https://img.shields.io/docker/stars/lazyteam/dcli.svg)](https://hub.docker.com/r/lazyteam/dcli)
[![Docker Automated](https://img.shields.io/docker/cloud/automated/lazyteam/dcli.svg)](https://hub.docker.com/r/lazyteam/dcli)
...
1. <details><summary>Click if you have an ARM device</summary><p>
    ...
    - If you have a ARM 32 bit v6 architecture
        ...
        ```sh
        docker build -t lazyteam/dcli \
        --build-arg BASE_IMAGE_BUILDER=arm32v6/golang \
        --build-arg GOARCH=arm \
        --build-arg GOARM=6 \
        https://github.com/jesseduffield/dcli.git
        ```
...
1. Run the container
    ...
    -v /yourpath:/.config/jesseduffield/dcli \
    lazyteam/dcli
    ```

    - Don't forget to change `/yourpath` to an actual path you created to store dcli's config
    - You can also use this [docker-compose.yml](https://github.com/jesseduffield/dcli/blob/master/docker-compose.yml)
    - You might want to create an alias, for example:

        ```sh
        echo "alias lzd='docker run --rm -it -v /var/run/docker.sock:/var/run/docker.sock -v /yourpath/config:/.config/jesseduffield/dcli lazyteam/dcli'" >> ~/.zshrc
        ```
...
```sh
git clone https://github.com/jesseduffield/dcli.git
cd dcli
docker build -t lazyteam/dcli \
...
Call `dcli` in your terminal. I personally use this a lot so I've made an alias for it like so:

```
echo "alias lzd='dcli'" >> ~/.zshrc
```
...
If you would like to support the development of dcli, consider [sponsoring me](https://github.com/sponsors/jesseduffield) (github is matching all donations dollar-for-dollar for 12 months)
...
By opening dcli, clicking on the 'project' panel in the top left, and pressing 'o' (or 'e' if your editor is vim). See [Config Docs](/docs/Config.md)
...
Mac Users: See [Issue #190](https://github.com/jesseduffield/dcli/issues/190) for other options.

### Why can't I see my container's logs?

By default we only show logs from the last hour, so that we're not putting too much strain on the machine. This may be why you can't see logs when you first start dcli. This can be overwritten in the config's `commandTemplates`

If you are running dcli in Docker container, it is a know bug, that you can't see logs or CPU usage.

## Alternatives

- [docui](https://github.com/skanehira/docui) - Skanehira beat me to the punch on making a docker terminal UI, so definitely check out that repo as well! I think the two repos can live in harmony though: dcli is more about managing existing containers/services, and docui is more about creating and configuring them.
